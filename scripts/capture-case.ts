 ...
 * right for a sweep and wrong for verifying the scorer: the diff is the evidence,
 * and §15.6 had to re-run a case to get one. This mirrors `runCase`'s computation
